 ...
 */
void MotorDrv::instantSpeed(int speed)
{
...
*/
void MotorDrv::targetSpeed(int speedTarget, int vel)
{
...
void MotorDrv::test(int max_test_speed)
{
    // MotorDrv::ACC_DEFAULT_VELOCITY = 20;
    // MotorDrv::BRAKE_DEFAULT_VELOCITY = 40;
